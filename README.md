...
trace
,,œ,,, README.md
,,œ,,, docs/                  # Markdown docs (single source)
,,œ,,, crates/
,,‚  ,,œ,,, trace-cli/          # Rust CLI (binary: trace; hosts the daemon)
,,‚  ,,œ,,, trace-daemon/       # Rust local API + localhost GUI server
,,‚  ,,,,,, trace-core/         # shared logic
,,œ,,, apps/
,,‚  ,,œ,,, web/                # React + Vite local dashboard
,,‚  ,,œ,,, desktop/            # native desktop shell (Tauri) wrapping the dashboard
,,‚  ,,œ,,, landing/            # public landing site (Vercel)
,,‚  ,,,,,, docs/               # docs site ,†’ GitHub Pages (renders /docs)
,,œ,,, integrations/
,,‚  ,,œ,,, github/             # GitHub App / Actions
,,‚  ,,œ,,, vscode/             # VS Code extension
,,‚  ,,œ,,, cursor/             # Cursor MCP server
,,‚  ,,œ,,, claude/             # Claude Code hooks adapter
,,‚  ,,,,,, codex/              # Codex CLI adapter
,,œ,,, packages/
,,‚  ,,,,,, npm/                # optional npm wrapper package
,,œ,,, homebrew-trace/        # Homebrew formula (mirrors the tap repo)
,,œ,,, firebase/              # optional static mirror / reserved identity
,,œ,,, scripts/               # install.sh, install.ps1
