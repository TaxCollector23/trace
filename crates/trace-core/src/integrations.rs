...
pub const INTEGRATIONS: &[IntegrationDef] = &[
    IntegrationDef {
        ...
        how: "Session + command + edit hooks",
        config_rel: &[".claude", "settings.json"],
        needle: "agent-hook.js",
        existence_only: false,
        command_enforcement: Some(true),
        file_review: Some(false),
        capability_note: "SessionStart/End create and finish a Trace run automatically. PreToolUse Bash denies block decisions before execution; PostToolUse edits are reviewed after they land and fed back to Claude.",
    },
    IntegrationDef {
        id: "cursor",
        display_name: "Cursor",
        how: "Session + command + edit hooks",
        config_rel: &[".cursor", "hooks.json"],
        needle: "agent-hook.js",
        existence_only: false,
        command_enforcement: Some(true),
        file_review: Some(false),
        capability_note: "Session hooks create and finish a Trace run. beforeShellExecution denies block decisions before execution; afterFileEdit records changes and reviews them after they land.",
    },
    IntegrationDef {
        id: "windsurf",
    ...
    IntegrationDef {
        id: "codex",
        display_name: "Codex",
        how: "Codex lifecycle hooks + wrapper fallback",
        config_rel: &[".codex", "hooks.json"],
        needle: "codex-hook.js",
        existence_only: false,
        command_enforcement: Some(true),
        file_review: Some(false),
        capability_note: "PreToolUse Bash hooks deny dangerous commands before execution in Codex CLI, desktop, and IDE surfaces that load ~/.codex/hooks.json. File edits are recorded and reviewed after the tool call, not blocked before it.",
    },
    IntegrationDef {
        id: "opencode",
        display_name: "OpenCode",
        how: "MCP tools + session guard plugin",
        config_rel: &[".config", "opencode", "opencode.json"],
        needle: "opencode/plugin/trace.js",
        existence_only: false,
        command_enforcement: Some(true),
        file_review: None,
        capability_note: "The V1 and V2 plugin hooks create a run on the first tool call, deny block decisions before Bash executes, record completed tools, and review the working tree after edits. A missing daemon fails closed for the guard.",
    },
];
