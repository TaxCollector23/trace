...
export default function About() {
  return (
    <div className="max-w-[700px] py-16">
      ...
      >
        It can edit any file, run any command, and touch your git history — and
        it does it in seconds, faster than anyone can read. Trace is the record of
      ...
      <Prose title="The failure nobody budgets for">
        ...
        found. By the time a human looks up, the change is done and the context —
        what changed, why, and what it touched on the way — is already gone.
        <br />
        <br />
      ...
      <Prose title="What Trace does about it">
        ...
        <ul className="mt-3 space-y-2">
          <li>
            ...
            state at the start of every run, so “undo the last hour” is one click —
            the safety net is already in place before the first edit lands.
          </li>
          <li>
            ...
            deletions per file — review it like a PR instead of trusting a summary.
          </li>
          <li>
            <b>A guard on every command.</b> Each command the agent runs is
            classified in real time — allow, warn, require approval, or block. The
          ...
          <li>
            <b>PR ratification.</b> Run the exact same checks over a pull request —
            from the dashboard or in CI — and get a clear <b>pass / review / block</b>{" "}
      ...
      <Prose title="Deterministic, local, and yours">
        ...
        on every machine — a guardrail you can trust in the tool-call path can't
